...
public class ListeDepartements extends javax.swing.JFrame {
    ...
    public ListeDepartements() {
     ...
     public void fillEtudiantTable(JTable table, String valueAchrecher ){
          ...
          String sql = "SELECT * FROM `Departement` WHERE CONCAT(`code`, `nom_depart`)LIKE ? ";
    ...
    private void initComponents() {
        ...
        jTableAfficheEt.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODE DEPARTEMENT", "NOM DEPARTEMENT"
            }
        ) {
        ...
        jLabel2.setText("LISTE COMPLETE DES DEPARTEMENTS  ");
        ...
        jLabel1.setText("Recherche departement par nom ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListeDepartements.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListeDepartements().setVisible(true);
            }
        });
    }
